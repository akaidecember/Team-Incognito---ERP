...
public class PurchasePaymentFrame extends javax.swing.JFrame {
    ...
    private void initComponents() {
        ...
        jComboBox2.setModel(new javax.swing.DefaultComboBoxModel<>(
                new String[] { "Search By Payment Details", "Payment Done", "Partial Payment", "Payable" }));
        ...
        jLabel7.setText("To:");
        jPanel1.add(jLabel7);
        jLabel7.setBounds(990, 100, 50, 23);
        ...
        jTextField5.setBounds(1070, 100, 220, 25);
        ...
        jTextField7.setBounds(1070, 50, 220, 25);

        jLabel10.setFont(new java.awt.Font("Calibri", 0, 18)); // NOI18N
        jLabel10.setText("From:");
        jPanel1.add(jLabel10);
        jLabel10.setBounds(990, 50, 60, 23);
        ...
        jTable1.setModel(new javax.swing.table.DefaultTableModel(
                ...
                new String[] {
                        ...
                        "Status", "Remaining Balance", "Description", "Select"
                }) {
        ...
        jButton4.setBounds(230, 600, 115, 35);
        ...
        jButton5.setBounds(355, 600, 110, 35);

        jButton13.setBackground(new java.awt.Color(0, 51, 102));
        jButton13.setFont(new java.awt.Font("Calibri", 1, 14)); // NOI18N
        jButton13.setForeground(new java.awt.Color(255, 255, 255));
        jButton13.setIcon(new javax.swing.ImageIcon(getClass().getResource("/icons/open.png"))); // NOI18N
        ...
        jButton13.setBounds(595, 600, 110, 35);

        jButton14.setBackground(new java.awt.Color(0, 51, 102));
        jButton14.setFont(new java.awt.Font("Calibri", 1, 14)); // NOI18N
        jButton14.setForeground(new java.awt.Color(255, 255, 255));
        jButton14.setIcon(new javax.swing.ImageIcon(getClass().getResource("/icons/cancel.png"))); // NOI18N
        ...
        jButton14.setBounds(475, 600, 110, 35);
        ...
        if (evt.getKeyCode() == KeyEvent.VK_ENTER) {
            ...
            try {
                ...
                for (int i = 0; i < tableinfo.size(); i++) {
                    ...
                    if (getDate(d3, d1) >= 0 && getDate(d3, d2) <= 0) {
                ...
                InsertDataToTable it = new InsertDataToTable();
                it.getDataInserted(jTable1, column, newsorted, 40);
                new InsertCheckBoxToJtable().getCheckBoxInserted(jTable1, "Select");
    ...
    public int getDate(Date d1, Date d2) {
    ...
    private void jButton2ActionPerformed(java.awt.event.ActionEvent evt) {// GEN-FIRST:event_jButton2ActionPerformed
        ...
        for (int i = 0; i < iteminfo.size(); i++) {
            ...
            pd.updatePurchasePaymentinfo((String) temp.get(0), (String) temp.get(1), date, (String) temp.get(3),
                    (String) temp.get(4), (String) temp.get(5), (String) temp.get(6), (String) temp.get(7),
                    (String) temp.get(8), LoginFrame.uname, LoginFrame.date);
            pd.updateSearchPaymentStatusinfo((String) temp.get(0), (String) temp.get(1), (String) temp.get(6),
                    LoginFrame.uname, LoginFrame.date);
        }
    ...
    private void jTable1KeyReleased(java.awt.event.KeyEvent evt) {// GEN-FIRST:event_jTable1KeyReleased
        ...
        if (index1 != -1) {
            ...
            String paying = (String) jTable1.getValueAt(index1, 4);

            if (!paying.equals("0.0")) {
                double inam = Double.parseDouble(inamount);
                double pay = Double.parseDouble(paying);
                double rembal = inam - pay;
                rembal = Double.parseDouble(new DecimalFormat("##.##").format(rembal));

                jTable1.setValueAt(Double.toString(rembal), index1, 7);

                if (rembal != 0.0) {
                    jTable1.setValueAt("Partial Payment", index1, 6);
                } else if (rembal == 0.0) {
                    jTable1.setValueAt("Payment Done", index1, 6);
                }
            }
        }
    ...
    private void jButton2KeyPressed(java.awt.event.KeyEvent evt) {// GEN-FIRST:event_jButton2KeyPressed
        ...
        for (int i = 0; i < iteminfo.size(); i++) {
            ArrayList temp = (ArrayList) iteminfo.get(i);
            // pd.updatePurchasePaymentinfo((String) temp.get(0), (String) temp.get(1),
            // (String) temp.get(2), (String) temp.get(3), (String) temp.get(4), (String)
            // temp.get(5), (String) temp.get(6), (String) temp.get(7), (String)
            // temp.get(8));
    ...
    private void jTable1MouseClicked(java.awt.event.MouseEvent evt) {// GEN-FIRST:event_jTable1MouseClicked
        ...
        // String str= jTable1.getValueAt(jTable1.getSelectedRow(),
    ...
    private void jButton3ActionPerformed(java.awt.event.ActionEvent evt) {// GEN-FIRST:event_jButton3ActionPerformed
        ...
        MessageFormat header = new MessageFormat("Purchase Payment");
        MessageFormat footer = new MessageFormat("-{0}-");

        getpdfPrint(header, footer);
        ...
        if (rownum == -1) {
            ...
            for (int i = 0; i < rowcount; i++) {
                ...
                if (jTable1.getValueAt(i, 9) != null) {
                    String str = jTable1.getValueAt(i, 9).toString();
                    if (str.equals("true")) {
                        ArrayList rowlist = new ArrayList();
                        for (int j = 0; j < column - 1; j++) {
                            String file = (String) jTable1.getValueAt(i, j);

                            rowlist.add(file);

                        }

                        double amount = Double.parseDouble((String) jTable1.getValueAt(i, 7));
                        totalamount = totalamount + amount;
                        selecteddata.add(rowlist);
                    }
                }

            }

            // System.out.println("Selected Row Data is ");
            // for (int i = 0; i < selecteddata.size(); i++)
            // {
            // System.out.println((ArrayList)selecteddata.get(i));
            // }

            SelectFileFrame.selectfile = selecteddata;
            SelectFileFrame.totalamount = Double.toString(totalamount);

            this.dispose();
            Dimension d = Toolkit.getDefaultToolkit().getScreenSize();

            SelectFileFrame lf = new SelectFileFrame();
            lf.setVisible(true);
            lf.setSize(d);
        }
    ...
    public static void main(String args[]) {
        ...
        try {
            ...
            java.util.logging.Logger.getLogger(PurchasePaymentFrame.class.getName()).log(java.util.logging.Level.SEVERE,
                    null, ex);
