   ...
   //============Insert ComboBox in Table=============================================  
    ...
    private void initComponents() {
        ...
        jTable1.setModel(new javax.swing.table.DefaultTableModel(
            ...
            new String [] {
                "Party Name", "Invoice No.", "Invoice Date", "Invoice Amount", "Paying", "Payment Mode", "Status", "Remaining Balance", "Description", "Select"
            }
        ) {
...
//            }
    ...
    private void jButton2ActionPerformed(java.awt.event.ActionEvent evt) {//GEN-FIRST:event_jButton2ActionPerformed
         ...
         for(int i=0;i<iteminfo.size();i++)
        {
          ...
          //   System.out.println("Temp: "+date);
             pd.updatePurchasePaymentinfo((String) temp.get(0), (String) temp.get(1), date, (String) temp.get(3), (String) temp.get(4), (String) temp.get(5), (String) temp.get(6), (String) temp.get(7), (String) temp.get(8), LoginFrame.uname, LoginFrame.date);
    ...
    private void jButton2KeyPressed(java.awt.event.KeyEvent evt) {//GEN-FIRST:event_jButton2KeyPressed
        ...
        {
            ArrayList temp=(ArrayList) iteminfo.get(i);
        //    pd.updatePurchasePaymentinfo((String) temp.get(0), (String) temp.get(1), (String) temp.get(2), (String) temp.get(3), (String) temp.get(4), (String) temp.get(5), (String) temp.get(6), (String) temp.get(7), (String) temp.get(8));
