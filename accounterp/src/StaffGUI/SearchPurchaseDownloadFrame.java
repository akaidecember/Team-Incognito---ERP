...
public class SearchPurchaseDownloadFrame extends javax.swing.JFrame {
    ...
    private void initComponents() {
        ...
        jRadioButton2.setText("Download in PDF Format");
    ...
    private void jRadioButton2ActionPerformed(java.awt.event.ActionEvent evt) {// GEN-FIRST:event_jRadioButton2ActionPerformed
        ...
        MessageFormat header = new MessageFormat("Search Purchase Details");
        MessageFormat footer = new MessageFormat("-{0}-");

        SearchPurchaseFrame pd = new SearchPurchaseFrame();
        pd.getpdfPrint(header, footer);
        this.dispose();
    ...
    public static void main(String args[]) {
        ...
        try {
            ...
            java.util.logging.Logger.getLogger(SearchPurchaseDownloadFrame.class.getName())
