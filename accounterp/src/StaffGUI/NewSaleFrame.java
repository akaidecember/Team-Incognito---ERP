...
public class NewSaleFrame extends javax.swing.JFrame {
        ...
        // }
            ...
            if (new SaleDB().isInvoiceExisted(invoicenum)) {
                ...
                for (int i = 0; i < uniqueitems.size(); i++) {
                    ...
                    sd.addSaleInfo(partyname, partygst, splace, purchasetypes, costcentres, salerefs, invoicenum, ponum,
                            invoicedate, paytermmdays, payduedate, temp.get(0).toString(), temp.get(1).toString(),
                            temp.get(2).toString(), temp.get(3).toString(), temp.get(4).toString(),
                            temp.get(5).toString(), temp.get(6).toString(), temp.get(7).toString(),
                            temp.get(8).toString(), temp.get(9).toString(), temp.get(10).toString(),
                            temp.get(11).toString(), temp.get(12).toString(), temp.get(13).toString(), totalinamount,
                            bankinfo, narrations, LoginFrame.uname, LoginFrame.date);
                ...
                sd.addSearchSaleInfo(partyname, partygst, invoicenum, invoicedate, totalinamount, totaltaxamount,
    ...
    public static void main(String args[]) {
        ...
        try {
            ...
            java.util.logging.Logger.getLogger(NewSaleFrame.class.getName()).log(java.util.logging.Level.SEVERE, null,
                    ex);
