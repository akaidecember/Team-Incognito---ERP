...
public class AddHomeCompanyProfileFrame extends javax.swing.JFrame {
    ...
    private void initComponents() {
        ...
        jComboBox1.setModel(new javax.swing.DefaultComboBoxModel<>(
                new String[] { "Select", "Andaman and Nicobar Islands", "Andhra Pradesh", "Arunachal Pradesh", "Assam",
                        "Bihar", "Chandigarh", "Chhattisgarh", "Delhi", "Dadra and Nagar Haveli", "Daman and Diu ",
                        ...
                        .addGroup(jPanel2Layout.createSequentialGroup()
                                ...
                                .addGroup(jPanel2Layout.createParallelGroup(javax.swing.GroupLayout.Alignment.LEADING)
                                        .addGroup(jPanel2Layout.createSequentialGroup()
                                                ...
                                                .addGap(92, 92, 92)
                                                .addComponent(jComboBox5, javax.swing.GroupLayout.PREFERRED_SIZE, 196,
                                                        javax.swing.GroupLayout.PREFERRED_SIZE))
                                        .addGroup(jPanel2Layout.createSequentialGroup()
                                                .addComponent(jLabel14)
                                                .addGap(18, 18, 18)
                                                .addComponent(jTextField9, javax.swing.GroupLayout.PREFERRED_SIZE, 176,
                                                        javax.swing.GroupLayout.PREFERRED_SIZE)
                                                .addGap(18, 18, 18)
                                                .addComponent(jLabel16)
                                                .addGap(45, 45, 45)
                                                .addComponent(jTextField11, javax.swing.GroupLayout.PREFERRED_SIZE, 161,
                                                        javax.swing.GroupLayout.PREFERRED_SIZE))
                                        .addGroup(jPanel2Layout.createSequentialGroup()
                                                .addComponent(jLabel15)
                                                .addGap(75, 75, 75)
                                                .addComponent(jTextField10, javax.swing.GroupLayout.PREFERRED_SIZE, 176,
                                                        javax.swing.GroupLayout.PREFERRED_SIZE)
                                                .addGap(18, 18, 18)
                ...
                jPanel4Layout.createParallelGroup(javax.swing.GroupLayout.Alignment.LEADING)
                        .addGroup(jPanel4Layout.createSequentialGroup()
                                ...
                                .addGroup(jPanel4Layout.createParallelGroup(javax.swing.GroupLayout.Alignment.LEADING)
                                        ...
                                        .addComponent(jScrollPane2, javax.swing.GroupLayout.PREFERRED_SIZE, 605,
                                                javax.swing.GroupLayout.PREFERRED_SIZE)
                                        .addGroup(jPanel4Layout.createSequentialGroup()
                        ...
                        .addGroup(jPanel1Layout.createSequentialGroup()
                                .addGroup(jPanel1Layout.createParallelGroup(javax.swing.GroupLayout.Alignment.LEADING)
                                        ...
                                        .addGroup(jPanel1Layout.createSequentialGroup()
                                                ...
                                                .addGap(6, 6, 6)
                                                .addComponent(jLabel5, javax.swing.GroupLayout.PREFERRED_SIZE, 193,
                                                        javax.swing.GroupLayout.PREFERRED_SIZE)
                                                .addGap(77, 77, 77)
                                                .addComponent(jLabel6)
                                                .addGap(40, 40, 40)
                                                .addComponent(jLabel26, javax.swing.GroupLayout.PREFERRED_SIZE, 193,
                                                        javax.swing.GroupLayout.PREFERRED_SIZE)))
        ...
        if (name.isEmpty()) {
            ...
            if (new HomeCompanyDB().isHomeCompanyAdded()) {
                JOptionPane.showMessageDialog(null,
                        "Already Your Home Ocmpany  Profile is been Added \n You can only Update now");
            } else {

                HomeCompanyDBOperation hd = new HomeCompanyDBOperation();
                if (hd.addHomeCompanyInfo(name, address, city, pin, state, mob, emailid, fdetails, nbusiness, ptype,
                        rnum, pan, gstnumber, gstscode, bankinfo, LoginFrame.uname, LoginFrame.date, logoname, path1,
                        signaturename, path2)) {
        ...
        if (evt.getKeyCode() == KeyEvent.VK_ENTER) {
            ...
            if (name.isEmpty()) {
                ...
                if (new HomeCompanyDB().isHomeCompanyAdded()) {
                    ...
                    HomeCompanyDBOperation hd = new HomeCompanyDBOperation();
                    if (hd.addHomeCompanyInfo(name, address, city, pin, state, mob, emailid, fdetails, nbusiness, ptype,
                            rnum, pan, gstnumber, gstscode, bankinfo, LoginFrame.uname, LoginFrame.date, logoname,
                            path1, signaturename, path2)) {
                        JOptionPane.showMessageDialog(null, "Home Company Information Saved Successfully");
                        bankdetails = new ArrayList();
                        accnum = new ArrayList();
                        jTextField1.setText("");
                        ...
                        JOptionPane.showMessageDialog(null,
                                "Problem Occured in Database operation \n Please Try Again");
                    }
                }
    ...
    public static void main(String args[]) {
        ...
        try {
            ...
            java.util.logging.Logger.getLogger(AddHomeCompanyProfileFrame.class.getName())
