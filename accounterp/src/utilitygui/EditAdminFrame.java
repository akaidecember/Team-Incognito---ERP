...
public class EditAdminFrame extends javax.swing.JFrame {
    ...
    public EditAdminFrame() {
        super("CHANGE ADMIN PASSWORD: Login By"+" "+LoginFrame.uname);
        initComponents();
...
jPasswordField2.setBorder(new LineBorder(clr,2));
    ...
    public static void main(String args[]) {
        ...
        try {
            ...
            java.util.logging.Logger.getLogger(EditAdminFrame.class.getName()).log(java.util.logging.Level.SEVERE, null, ex);
        ...
        java.awt.EventQueue.invokeLater(new Runnable() {
            public void run() {
                new EditAdminFrame().setVisible(true);
            }
        });
    }
