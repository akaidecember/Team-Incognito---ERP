...
public class SalePartyNameSearchFilter extends javax.swing.JFrame {
        ...
        if (pstr.isEmpty()) {
            ...
            if (gst.equals("Unregistered")) {
                ...
                if (bankdetails.equals("No Bank Info")) {
                    ...
                    NewSaleFrame.jLabel5.setText("<html><div style='text-align: left;'>" + (String) partyinfo.get(0)
                    ...
                    // NewPurchaseFrame.jComboBox4.setModel(new
                    // DefaultComboBoxModel<String>((String[]) centers.toArray(new String[0])));
                    ...
                    // DefaultComboBoxModel<String>((String[]) centers.toArray(new String[0])));
                    // NewPurchaseFrame.jComboBox3.setSelectedItem(gst);
                    NewSaleFrame.jLabel14.setText("<html><div style='text-align: left;'>" + "Bank Name: " + bstr[0]
    ...
    public static void main(String args[]) {
        ...
        try {
            ...
            java.util.logging.Logger.getLogger(SalePartyNameSearchFilter.class.getName())
