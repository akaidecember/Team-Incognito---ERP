...
public class ItemNameFilter extends javax.swing.JFrame {
    ...
    private void jList1MouseClicked(java.awt.event.MouseEvent evt) {// GEN-FIRST:event_jList1MouseClicked
        ...
        // JOptionPane.showMessageDialog(rootPane,jList1.getSelectedValue(), "Selected
    ...
    public static void main(String args[]) {
        ...
        try {
            ...
            java.util.logging.Logger.getLogger(ItemNameFilter.class.getName()).log(java.util.logging.Level.SEVERE, null,
                    ex);
