...
public class PartyNameSearchFilter extends javax.swing.JFrame {
        ...
        if (pstr.isEmpty()) {
            ...
            if (gst.equals("Unregistered")) {
                ...
                if (bankdetails.equals("No Bank Info")) {
                    ...
                    NewPurchaseFrame.jLabel5.setText("<html><div style='text-align: left;'>" + (String) partyinfo.get(0)
                            + "<br>" + (String) partyinfo.get(1) + "<br>" + (String) partyinfo.get(2) + "<br>"
                            + (String) partyinfo.get(3) + "</div></html>");
                    ...
                    NewPurchaseFrame.jLabel5.setText("<html><div style='text-align: left;'>" + (String) partyinfo.get(0)
                            ...
                            + (String) partyinfo.get(3) + "</div></html>");
                    NewPurchaseFrame.jLabel6.setText((String) partyinfo.get(4));
                    NewPurchaseFrame.jLabel14.setText("<html><div style='text-align: left;'>" + "Bank Name: " + bstr[0]
                            + "<br>" + "Account Number: " + bstr[1] + "<br>" + "IFSC Code: " + bstr[2] + "<br>"
                            + "Account Name: " + bstr[3] + "<br>" + "Account Type: " + bstr[4] + "</div></html>");
            ...
            if (pstr.isEmpty()) {
                ...
                if (gst.equals("Unregistered")) {
                    ...
                    if (bankdetails.equals("No Bank Info")) {
                        bankinfo = "No Bank info";
                        NewPurchaseFrame.jLabel14.setText(bankinfo);
                        NewPurchaseFrame.jLabel5.setText("<html><div style='text-align: left;'>"
                                + (String) partyinfo.get(0) + "<br>" + (String) partyinfo.get(1) + "<br>"
                                + (String) partyinfo.get(2) + "<br>" + (String) partyinfo.get(3) + "</div></html>");
                        NewPurchaseFrame.jLabel6.setText((String) partyinfo.get(4));
                    } else {
                        ...
                        NewPurchaseFrame.jLabel5.setText("<html><div style='text-align: left;'>"
                                ...
                                + (String) partyinfo.get(2) + "<br>" + (String) partyinfo.get(3) + "</div></html>");
                        NewPurchaseFrame.jLabel6.setText((String) partyinfo.get(4));
                        NewPurchaseFrame.jLabel14.setText("<html><div style='text-align: left;'>" + "Bank Name: "
                                + bstr[0] + "<br>" + "Account Number: " + bstr[1] + "<br>" + "IFSC Code: " + bstr[2]
                                + "<br>" + "Account Name: " + bstr[3] + "<br>" + "Account Type: " + bstr[4]
                                + "</div></html>");
    ...
    public static void main(String args[]) {
        ...
        try {
            ...
            java.util.logging.Logger.getLogger(PartyNameSearchFilter.class.getName())
