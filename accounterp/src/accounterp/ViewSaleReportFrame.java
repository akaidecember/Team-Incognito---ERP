 ...
 * @author 1450
 */
public class ViewSaleReportFrame extends javax.swing.JFrame {

    /**
     * Creates new form ViewSaleReportFrame
     */
    public ViewSaleReportFrame() {
    ...
    public static void main(String args[]) {
        ...
        try {
            ...
            java.util.logging.Logger.getLogger(ViewSaleReportFrame.class.getName()).log(java.util.logging.Level.SEVERE, null, ex);
        ...
        java.awt.EventQueue.invokeLater(new Runnable() {
            public void run() {
                new ViewSaleReportFrame().setVisible(true);
            }
        });
    }
