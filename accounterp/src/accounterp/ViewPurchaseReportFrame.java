 ...
 * @author 1450
 */
public class ViewPurchaseReportFrame extends javax.swing.JFrame {

    /**
     * Creates new form ViewSaleReportFrame
     */
    public ViewPurchaseReportFrame() {
    ...
    public static void main(String args[]) {
        ...
        try {
            ...
            java.util.logging.Logger.getLogger(ViewPurchaseReportFrame.class.getName()).log(java.util.logging.Level.SEVERE, null, ex);
        ...
        java.awt.EventQueue.invokeLater(new Runnable() {
            public void run() {
                new ViewPurchaseReportFrame().setVisible(true);
            }
        });
    }
