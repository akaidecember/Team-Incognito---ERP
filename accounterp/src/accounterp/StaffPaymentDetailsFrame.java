 ...
 * @author 1450
 */
public class StaffPaymentDetailsFrame extends javax.swing.JFrame {

    /**
     * Creates new form StaffPaymentDetailsFrame
     */
    public StaffPaymentDetailsFrame() {
        super("STAFF PAYMENT DETAILS");
        initComponents();
    }
    ...
    private void initComponents() {
        ...
        jTable1.setModel(new javax.swing.table.DefaultTableModel(
            ...
            new String [] {
                "Staff ID", "Staff Name", "Month", "Working Days", "STD", "Net Payment", "Deduction"
            }
        ));
    ...
    public static void main(String args[]) {
        ...
        try {
            ...
            java.util.logging.Logger.getLogger(StaffPaymentDetailsFrame.class.getName()).log(java.util.logging.Level.SEVERE, null, ex);
        ...
        java.awt.EventQueue.invokeLater(new Runnable() {
            public void run() {
                new StaffPaymentDetailsFrame().setVisible(true);
            }
        });
    }
