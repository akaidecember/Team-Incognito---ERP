 ...
 * @author 1450
 */
public class ViewPurchaseReportCEOFrame extends javax.swing.JFrame {

    /**
     * Creates new form ViewSaleReportFrame
     */
    public ViewPurchaseReportCEOFrame() {
        super("VIEW PURCHASE REPORT");
        initComponents();
    }
    ...
    private void initComponents() {
        ...
        jLabel1.setIcon(new javax.swing.ImageIcon(getClass().getResource("/icons/graph.jpg"))); // NOI18N
    ...
    public static void main(String args[]) {
        ...
        try {
            ...
            java.util.logging.Logger.getLogger(ViewPurchaseReportCEOFrame.class.getName()).log(java.util.logging.Level.SEVERE, null, ex);
        ...
        java.awt.EventQueue.invokeLater(new Runnable() {
            public void run() {
                new ViewPurchaseReportCEOFrame().setVisible(true);
            }
        });
    }
