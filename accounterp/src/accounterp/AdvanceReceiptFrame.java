 ...
 * @author welcome
 */
public class AdvanceReceiptFrame extends javax.swing.JFrame {

    /**
     * Creates new form AdvancePaymentFrame
     */
    public AdvanceReceiptFrame() {
        
        super("ADVANCE RECEIPT");
        initComponents();
    ...
    private void initComponents() {
        ...
        jComboBox3.setModel(new javax.swing.DefaultComboBoxModel<>(new String[] { "Receipt Mode", "Cash", "Cheque", "e-Payment" }));
    ...
    public static void main(String args[]) {
        ...
        try {
            ...
            java.util.logging.Logger.getLogger(AdvanceReceiptFrame.class.getName()).log(java.util.logging.Level.SEVERE, null, ex);
        ...
        java.awt.EventQueue.invokeLater(new Runnable() {
            public void run() {
                new AdvanceReceiptFrame().setVisible(true);
            }
        });
    }
