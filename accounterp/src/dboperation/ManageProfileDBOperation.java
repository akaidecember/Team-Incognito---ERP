...
public class ManageProfileDBOperation {
    ...
    public boolean updatePassword(String uname, String pass, String loginby, String logindate) {
        ...
        try {
            ...
            Statement st = new DBDriver().getStatment();
            String query = "Update managerinfo set Password='" + pass + "',Login_By='" + loginby + "',Login_Date='"
                    + logindate + "' where Username='" + uname + "'";
    ...
    public boolean createNewStaff(String name, String dob, String mob, String email, String uname, String pass,
            String datetime, String loginby, String logindate) {
        boolean flag = true;

        try {

            Statement st = new DBDriver().getStatment();
            String query = "Insert into newstaffinfo values('" + name + "','" + dob + "','" + mob + "','" + email
                    + "','" + uname + "','" + pass + "','" + datetime + "','" + loginby + "','" + logindate + "')";
            int x = st.executeUpdate(query);
    ...
    public boolean updateStaffinfo(String name, String dob, String mob, String email, String uname, String pass,
            String datetime, String loginby, String logindate) {
        boolean flag = true;
        try {

            Statement st = new DBDriver().getStatment();
            String query = "Update newstaffinfo set Date_of_Birth='" + dob + "',Mobile_Number='" + mob + "',Email_Id='"
                    + email + "',Password='" + pass + "',Date_Time='" + datetime + "',Login_By='" + loginby
                    + "',Login_Date='" + logindate + "',Name='" + name + "' where Username='" + uname + "'";
            int x = st.executeUpdate(query);
    ...
    public ArrayList getAllStaffReportInfo() {
        ...
        try {
            ...
            System.out
                    .println("Exception in ManageProfileDBOperation Class in getAllStaffReportInfo() method is: " + e);
