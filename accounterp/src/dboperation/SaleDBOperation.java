...
public class SaleDBOperation {
    ...
    public boolean addSaleInfo(String pname, String gstin, String supplyplace, String stype, String ccentre,
        ...
        try {
            ...
            Statement st = new DBDriver().getStatment();
            String query = "Insert into saleinfo values('" + pname + "','" + gstin + "','" + supplyplace + "','" + stype
                    + "','" + ccentre + "','" + saleref + "','" + inum + "','" + ponum + "','" + idate + "','" + ptdays
                    + "','" + pduedate + "' ,'" + iname + "','" + idescrip + "','" + hsnsaccode + "','" + gstrate
                    + "','" + unit + "','" + quantity + "', '" + rate + "','" + amount + "','" + discount + "','"
    ...
    public boolean addSearchSaleInfo(String pname, String gstin, String inum, String idate, String ivalue,
        ...
        try {
            ...
            Statement st = new DBDriver().getStatment();
            String query = "Insert into searchsaleinfo values('" + pname + "','" + gstin + "','" + inum + "','" + idate
                    + "','" + ivalue + "','" + totaltaxamount + "','" + cgst + "','" + sgst + "','" + igst + "','"
    ...
    public boolean updateSearchSaleinfo(String pname, String gstin, String inum, String idate, String ivalue,
            String totaltaxamount, String cgst, String sgst, String igst, String paystatus, String loginby,
            String logindate) {
        boolean flag = true;
        try {
            ...
            Statement st = new DBDriver().getStatment();
            String query = "Update searchsaleinfo set Party_Name='" + pname + "',GSTIN='" + gstin + "',Invoice_Date='"
                    + idate + "',Invoice_Value='" + ivalue + "',Taxable_Amount='" + totaltaxamount + "',CGST='" + cgst
                    + "',SGST='" + sgst + "' ,IGST='" + igst + "',Payment_Status='" + paystatus + "',Login_By='"
                    + loginby + "',Login_Date='" + logindate + "'where Invoice_Number='" + inum + "'";
            int x = st.executeUpdate(query);
    ...
    public boolean updateSearchPaymentStatusinfo(String pname, String inum, String paystatus, String loginby,
        ...
        try {
            ...
            Statement st = new DBDriver().getStatment();
            String query = "Update searchsaleinfo set Payment_Status='" + paystatus + "',Login_By='" + loginby
    ...
    public boolean updateNewSaleinfo(String pname, String gstin, String supplyplace, String ptype, String ccentre,
            String saleref, String inum, String ponum, String idate, String ptdays, String pduedate, String iname,
            String idescrip, String hsnsaccode, String gstrate, String unit, String quantity, String rate,
            String amount, String discount, String taxamount, String cgst, String sgst, String igst, String total,
            String tiamount, String bdetails, String narration, String loginby, String logindate) {
        ...
        try {
            ...
            Statement st = new DBDriver().getStatment();
            String query = "Update saleinfo set GSTIN='" + gstin + "',Place_of_Supply='" + supplyplace + "',Sale_Type='"
                    + ptype + "',Cost_Centre='" + ccentre + "',Sale_Ref='" + saleref + "',PO_Number='" + ponum
                    + "',Invoice_Date='" + idate + "',Payment_Term_Days='" + ptdays + "',Payment_Due_Date='" + pduedate
                    + "',Item_Description='" + idescrip + "',HSN_SAC_Code='" + hsnsaccode + "',GST_Rate='" + gstrate
                    + "',Unit='" + unit + "',Quantity='" + quantity + "',Rate='" + rate + "',Amount='" + amount
                    + "',Discount='" + discount + "',Taxable_Amount='" + taxamount + "',CGST='" + cgst + "',SGST='"
                    + sgst + "',IGST='" + igst + "',Total='" + total + "',Total_Invoice_Amount='" + tiamount
                    + "',Bank_Details='" + bdetails + "',Narration='" + narration + "',Login_By='" + loginby
                    + "',Login_Date='" + logindate + "'where Party_Name='" + pname + "' and Invoice_Number='" + inum
                    + "'and Item_Name='" + iname + "'";
