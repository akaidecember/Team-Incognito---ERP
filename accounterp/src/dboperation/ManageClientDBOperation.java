...
public class ManageClientDBOperation {
    ...
    public boolean addPartyInfo(String name, String add, String city, String pin, String state, String mob,
            String email, String pan, String gst, String gstscode, String ptype, String bankdetails, String cpname,
            String cpmob, String cpemail, String loginby, String logindate) {
        boolean flag = true;

        try {

            Statement st = new DBDriver().getStatment();
            String query = "Insert into partyinfo values('" + name + "','" + add + "','" + city + "','" + pin + "','"
                    + state + "','" + mob + "','" + email + "' ,'" + pan + "','" + gst + "','" + gstscode + "','"
                    + ptype + "','" + bankdetails + "', '" + cpname + "','" + cpmob + "','" + cpemail + "','" + loginby
                    + "','" + logindate + "')";
    ...
    public boolean updatePartyinfo(String name, String add, String city, String pin, String state, String mob,
            String email, String pan, String gst, String gstscode, String ptype, String bankdetails, String cpname,
            String cpmob, String cpemail, String loginby, String logindate) {
        boolean flag = true;
        try {
            ...
            Statement st = new DBDriver().getStatment();
            String query = "Update partyinfo set Address='" + add + "',City='" + city + "',Pin='" + pin + "',State='"
                    + state + "',Contact_Number='" + mob + "',Email_Id='" + email + "',PAN_Number='" + pan
                    + "' ,GSTIN='" + gst + "',GST_State_Code='" + gstscode + "',Party_Type='" + ptype
                    + "',Bank_Details='" + bankdetails + "',Contact_Person_Name='" + cpname
                    + "',Contact_Person_Number='" + cpmob + "',Contact_Person_Email='" + cpemail + "',Login_By='"
                    + cpemail + "',Login_Date='" + cpemail + "'where Name='" + name + "'";
            int x = st.executeUpdate(query);
