...
public class PurchaseDBOperation {
    ...
    public ArrayList getPartyNames()
    {
        ...
        try
           ...
           {
               System.out.println("Exeption in PurchaseDBOperation Class and methid is getPartyNames(): "+e);
           }
...
//              iteminfo.add(itemname);
    ...
    public boolean addPurchasePaymentInfo(String pname, String inum, String idate, String iamount,String paying, String paymode, String status, String remamount, String descrip , String loginby, String logindate)
    {
        boolean flag=true;
        ...
        try
        {
             ...
             Statement st= new DBDriver().getStatment();
             String query="Insert into purchasepaymentinfo values('"+pname+"','"+inum+"','"+idate+"','"+iamount+"','"+paying+"','"+paymode+"','"+status+"','"+remamount+"','"+descrip+"','"+loginby+"','"+logindate+"')";
             int x=st.executeUpdate(query);
      ...
      ArrayList searchinfo=new ArrayList();       
        ...
        try
        {
             ...
             while(rs1.next())
            {
             ...
             if(Double.parseDouble(paying)==0.0)
             {
                 rembalan=invoiceamount;
             }
             else
             {
                 rembalan=rs1.getString(8);
             }
        ...
        {
            System.out.println("Exeption in PurchaseDBOperation Class and meethod is getAllPurchasePaymentInfo(): "+e);
       ...
       public boolean updateSearchPaymentStatusinfo(String pname, String inum, String paystatus, String loginby, String logindate)
    {
     ...
     public boolean updatePurchasePaymentinfo(String pname, String inum, String idate, String iamount,String paying, String paymode, String status, String remamount, String descrip, String loginby, String logindate )
    {
        boolean flag=true;
         try
        {
             ...
             Statement st= new DBDriver().getStatment();
             String query="Update purchasepaymentinfo set Party_Name='"+pname+"',Invoice_Date='"+idate+"',Invoice_Amount='"+iamount+"',Paying='"+paying+"',Payment_Mode='"+paymode+"',Status='"+status+"' ,Remaining_Balance='"+remamount+"',Description='"+descrip+"',Login_By='"+loginby+"',Login_Date='"+logindate+"'where Invoice_Number='"+inum+"'";
             int x=st.executeUpdate(query);
...
//        catch(Exception e)
//        {
//            System.out.println("Exeption in ManagePartyDBOperation Class is: "+e);
//            flag=false;
//        }
//        
//        
