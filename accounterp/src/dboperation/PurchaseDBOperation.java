...
public class PurchaseDBOperation {
    ...
    public boolean addPurchaseInfo(String pname, String gstin, String supplyplace, String ptype, String ccentre,
            String saleref, String inum, String ponum, String idate, String ptdays, String pduedate, String iname,
            String idescrip, String hsnsaccode, String gstrate, String unit, String quantity, String rate,
            String amount, String discount, String taxamount, String cgst, String sgst, String igst, String total,
            String tiamount, String bdetails, String narration, String loginby, String logindate) {
        boolean flag = true;

        try {

            Statement st = new DBDriver().getStatment();
            String query = "Insert into purchaseinfo values('" + pname + "','" + gstin + "','" + supplyplace + "','"
                    + ptype + "','" + ccentre + "','" + saleref + "','" + inum + "','" + ponum + "','" + idate + "','"
                    + ptdays + "','" + pduedate + "' ,'" + iname + "','" + idescrip + "','" + hsnsaccode + "','"
                    + gstrate + "','" + unit + "','" + quantity + "', '" + rate + "','" + amount + "','" + discount
                    + "','" + taxamount + "','" + cgst + "','" + sgst + "','" + igst + "','" + total + "','" + tiamount
                    + "','" + bdetails + "','" + narration + "','" + loginby + "','" + logindate + "')";
    ...
    public boolean addGSTTableInfo(String pname, String inum, String gstrate, String taxamount, String cgst,
        ...
        try {
            ...
            Statement st = new DBDriver().getStatment();
            String query = "Insert into gsttable values('" + pname + "','" + inum + "','" + gstrate + "','" + taxamount
                    + "','" + cgst + "','" + sgst + "','" + igst + "')";
            int x = st.executeUpdate(query);
    ...
    public boolean addSearchPurchaseInfo(String pname, String gstin, String inum, String idate, String ivalue,
            String totaltaxamount, String cgst, String sgst, String igst, String paystatus, String loginby,
            String logindate) {
        boolean flag = true;
        ...
        try {
            ...
            Statement st = new DBDriver().getStatment();
            String query = "Insert into searchpurchaseinfo values('" + pname + "','" + gstin + "','" + inum + "','"
                    + idate + "','" + ivalue + "','" + totaltaxamount + "','" + cgst + "','" + sgst + "','" + igst
                    + "','" + paystatus + "','" + loginby + "','" + logindate + "')";
            int x = st.executeUpdate(query);
    ...
    public boolean addPurchasePaymentInfo(String pname, String inum, String idate, String iamount, String paid,
            String paying, String paymode, String status, String remamount, String descrip, String loginby,
            String logindate) {
        boolean flag = true;
        ...
        try {
            ...
            String[] date1 = idate.split("/");
            idate = date1[2] + "-" + date1[1] + "-" + date1[0];
            String query = "Insert into purchasepaymentinfo values('" + pname + "','" + inum + "','" + idate + "','"
                    + iamount + "','" + paid + "','" + paying + "','" + paymode + "','" + status + "','" + remamount
                    + "','" + descrip + "','" + loginby + "','" + logindate + "')";
            int x = st.executeUpdate(query);
    ...
    public ArrayList getAllPurchasePaymentInfo() {
        ...
        try {
            ...
            System.out
                    .println("Exception in PurchaseDBOperation Class and meethod is getAllPurchasePaymentInfo(): " + e);
    ...
    public boolean updateGSTinfo(String pname, String inum, String gstrate, String taxamount, String cgst, String sgst,
            String igst) {
        boolean flag = true;
        try {

            Statement st = new DBDriver().getStatment();
            String query = "Update gsttable set GST_Rate='" + gstrate + "',Taxable_Amount='" + taxamount + "',CGST='"
                    + cgst + "',SGST='" + sgst + "',IGST='" + igst + "',CGST='" + cgst + "',SGST='" + sgst + "' ,IGST='"
                    + igst + "'where Party_Name='" + pname + "' and Invoice_Num='" + inum + "'";
            int x = st.executeUpdate(query);
    ...
    public boolean updateSearchPurchaseinfo(String pname, String gstin, String inum, String idate, String ivalue,
            String totaltaxamount, String cgst, String sgst, String igst, String paystatus, String loginby,
            String logindate) {
        boolean flag = true;
        try {
            ...
            Statement st = new DBDriver().getStatment();
            String query = "Update searchpurchaseinfo set Party_Name='" + pname + "',GSTIN='" + gstin
                    + "',Invoice_Date='" + idate + "',Invoice_Value='" + ivalue + "',Taxable_Amount='" + totaltaxamount
                    + "',CGST='" + cgst + "',SGST='" + sgst + "' ,IGST='" + igst + "',Payment_Status='" + paystatus
                    + "',Login_By='" + loginby + "',Login_Date='" + logindate + "'where Invoice_Number='" + inum + "'";
            int x = st.executeUpdate(query);
    ...
    public boolean updateSearchPaymentStatusinfo(String pname, String inum, String paystatus, String loginby,
            String logindate) {
        boolean flag = true;
        try {

            Statement st = new DBDriver().getStatment();
            String query = "Update searchpurchaseinfo set Payment_Status='" + paystatus + "',Login_By='" + loginby
                    + "',Login_Date='" + logindate + "'where Invoice_Number='" + inum + "' and Party_Name='" + pname
                    + "'";
            int x = st.executeUpdate(query);
    ...
    public boolean updatePurchasePaymentinfo(String pname, String inum, String idate, String iamount, String paid,
            String paying, String paymode, String status, String remamount, String descrip, String loginby,
            String logindate) {
        boolean flag = true;
        try {
            ...
            Statement st = new DBDriver().getStatment();
            String query = "Update purchasepaymentinfo set Party_Name='" + pname + "',Invoice_Date='" + idate
                    + "',Invoice_Amount='" + iamount + "',Paid='" + paid + "',Paying='" + paying + "',Payment_Mode='"
                    + paymode + "',Status='" + status + "' ,Remaining_Balance='" + remamount + "',Description='"
                    + descrip + "',Login_By='" + loginby + "',Login_Date='" + logindate + "'where Invoice_Number='"
                    + inum + "'";
            int x = st.executeUpdate(query);
    ...
    public boolean updateNewPurchaseinfo(String pname, String gstin, String supplyplace, String ptype, String ccentre,
            String saleref, String inum, String ponum, String idate, String ptdays, String pduedate, String iname,
            String idescrip, String hsnsaccode, String gstrate, String unit, String quantity, String rate,
            String amount, String discount, String taxamount, String cgst, String sgst, String igst, String total,
            String tiamount, String bdetails, String narration, String loginby, String logindate) {
        ...
        try {
            ...
            Statement st = new DBDriver().getStatment();
            String query = "Update purchaseinfo set GSTIN='" + gstin + "',Place_of_Supply='" + supplyplace
                    + "',Purchase_Type='" + ptype + "',Cost_Centre='" + ccentre + "',Sale_Ref='" + saleref
                    + "',PO_Number='" + ponum + "',Invoice_Date='" + idate + "',Payment_Term_Days='" + ptdays
                    + "',Payment_Due_Date='" + pduedate + "',Item_Description='" + idescrip + "',HSN_SAC_Code='"
                    + hsnsaccode + "',GST_Rate='" + gstrate + "',Unit='" + unit + "',Quantity='" + quantity + "',Rate='"
                    + rate + "',Amount='" + amount + "',Discount='" + discount + "',Taxable_Amount='" + taxamount
                    + "',CGST='" + cgst + "',SGST='" + sgst + "',IGST='" + igst + "',Total='" + total
                    + "',Total_Invoice_Amount='" + tiamount + "',Bank_Details='" + bdetails + "',Narration='"
                    + narration + "',Login_By='" + loginby + "',Login_Date='" + logindate + "'where Party_Name='"
                    + pname + "' and Invoice_Number='" + inum + "'and Item_Name='" + iname + "'";
    ...
    public boolean addAdvancePaymentInfo(String pname, String amount, String date, String pmode, String description) {
        ...
        try {
            ...
            Statement st = new DBDriver().getStatment();
            String query = "Insert into advancepaymentinfo values('" + pname + "','" + amount + "','" + date + "','"
                    + pmode + "','" + description + "')";
            int x = st.executeUpdate(query);
    ...
    public boolean updateAdvancePaymentInfo(String pname, String amount, String date, String pmode,
            String description) {
        boolean flag = true;
        try {

            Statement st = new DBDriver().getStatment();
            String query = "Update advancepaymentinfo set Amount='" + amount + "',Date='" + date + "',Payment_Mode='"
                    + pmode + "',Description='" + description + "'where Party_Name='" + pname + "'";
